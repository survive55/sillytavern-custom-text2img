...
const RUNTIME_FILES = Object.freeze(['index.js', 'generation.js', 'logs.js', 'logs-ui.js', 'providers.js', 'http.js', 'manual-llm.js', 'llm-presets.js', 'preset-regex.js', 'preset-macros.js', 'scene-text.js', 'inline-scenes.js', 'preset-runtime.js', 'preset-worker.js', 'preset-worker-client.js', 'preset-frame.js', 'preset-conversation.js', 'panel.js', 'novelai.js', 'novelai-payload.js', 'images.js', 'token-vault.js', 'settings.html', 'style.css', 'package.json', 'README.md', 'manifest.json']);
